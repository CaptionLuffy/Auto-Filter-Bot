...
# Bot Admins
ADMINS = environ.get('ADMINS', '853554999 1280356202') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002306437906').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002220715372').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002366998439') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001898953861') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://atlasadmin:zoro7890@cluster0.jcefere.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongo db url
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/group700909')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/TGBotsCode')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/RkMovie_group')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/shareus_open_tutorial")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/shareus_open_tutorial")
